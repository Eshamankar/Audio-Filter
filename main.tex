...
\begin{lstlisting}
https://github.com/Eshamankar/Audio-Filter/tree/main/codes/Esha1.wav
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Eshamankar/Audio-Filter/tree/main/codes/n.c
\end{lstlisting} 
The following code plots \eqref{prob:2.1} and \eqref{prob:2.2}
\begin{lstlisting}
https://github.com/Eshamankar/Audio-Filter/tree/main/codes/n.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Eshamankar/Audio-Filter/tree/main/codes/m.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Eshamankar/Audio-Filter/tree/main/codes/l.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Eshamankar/Audio-Filter/tree/main/codes/k.py
\end{lstlisting}
\begin{figure}[!ht]
\centering
...
%
\begin{lstlisting}
https://github.com/Eshamankar/Audio-Filter/tree/main/codes/p.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Eshamankar/Audio-Filter/tree/main/codes/q.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Eshamankar/Audio-Filter/tree/main/codes/r.py 
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Eshamankar/Audio-Filter/tree/main/codes/s.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Eshamankar/Audio-Filter/tree/main/codes/t.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{align}
	...
	&= \brak{0.00737405\times 10^{-5}}x(n) + \brak{0.02949621\times 10^{-5}}x(n - 1) \nonumber \\
	&+ \brak{0.04424432 \times 10^{-5}}x(n - 2) + \brak{0.02949621 \times 10^{-5}}x(n - 3) \nonumber \\
	&+ \brak{0.00737405 \times 10^{-5}}x(n - 4)
\end{align}
...
\begin{lstlisting}
https://github.com/Eshamankar/Audio-Filter/tree/main/codes/u.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Eshamankar/Audio-Filter/tree/main/codes/v.py
\end{lstlisting}
\begin{figure}[H]
\centering
